...
class Dbutilisateur
{
    ...
    public static function GetUtilisateur($utilisateurId)
    {
        try {
            ...
            Admin FROM utilisateur WHERE Id = :utilisateurId');
            $req->execute(array(':utilisateurId' => $utilisateurId));
    ...
    public static function GetUtilisateurByMail($adresseMail)
    {
        try {
            $bdd = PdoHelper::getInstance();
            //on prepare la requete
            $req = $bdd->DataBase->prepare('SELECT Id, Nom, Prenom, Mail FROM utilisateur WHERE Mail = :adresseMail');
    ...
    public static function getUserProgression($CollectiviteId)
    {
        try {
            $result = [];
            $bdd = PdoHelper::getInstance();
            //on prepare la requete
            $req = $bdd->DataBase->prepare("SELECT categorie.Id as CategorieId, utilisateurReponse.CollectiviteId as UtilisateurId, count(DISTINCT(utilisateurReponse.IdQuestion)) as NbRepondu
    ...
    public static function getUserScore($CollectiviteId)
    {
        try {
            $result = [];
            $bdd = PdoHelper::getInstance();
    ...
    public static function getUserProgressionCateg($CollectiviteId, $CategId)
    {
        try {
            $result = [];
            $bdd = PdoHelper::getInstance();
            ...
            GROUP BY categorie.Id");
            $req->execute(array(':CollectiviteId' => $CollectiviteId, ':CategId' => $CategId));
    ...
    public static function deleteUser($userId)
    {
        ...
        try {
            $bdd = PdoHelper::getInstance();
            //on prepare la requete
            $req = $bdd->DataBase->prepare("DELETE FROM `utilisateur` WHERE `Id` = :Id");
    ...
    public static function checkOldPass($oldPass)
    {
        ...
        FROM `utilisateur` WHERE  MotDePasse=:oldPass");
