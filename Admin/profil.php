...
<!-- <title>L'éco-clic Admin - Profil</title>
...
<div id="content" class="container-fluid">
    ...
    <div class="profil-body" style="overflow: auto;">
        ...
        <div class="monProfil">
            <form action="../AjaxLoader/UpdateUtilisateurProfilAdmin.php?type=infos" id="formulaire">
        ...
        <div class="motDePasse">
            <form action="../AjaxLoader/UpdateUtilisateurProfilAdmin.php?type=mdp" id="formulaireMdp">
