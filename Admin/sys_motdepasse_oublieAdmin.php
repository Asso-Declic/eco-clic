...
$utilisateur = DbAdministrateur::GetUtilisateurByMail($mail);
...
else
{
    ...
    DbAdministrateur::UpdateMotDePasseOublie($id, $utilisateur->Id);
    ...
    MailHelper::SendMailMotDePasseOublieAdmin($mail, $utilisateur->Nom, $utilisateur->Prenom, $recuperation);
