...
if (SessionHelper::GetCurrentUserAdministrateur()->SuperAdmin == 1) {
...
// $fil1->Icone = null;
// $fil1->Lien = "./utilisateursOPSN.php";
// $Arianne[] = $fil1;
...
<div class="modal fade" id="ModaleAjoutUtilisateurs" tabindex="-1" aria-labelledby="ModaleAjoutUtilisateursLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../AjaxLoader/InsertUtilisateursOPSN.php">
...
<div class="d-flex justify-content-end col-12">
    <button id="add"><i class="fas fa-plus-circle"></i> Utilisateur</button>
</div>
...
<script src="./js/utilisateursOPSN.js"></script>