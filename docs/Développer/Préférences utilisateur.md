...
On peut manipuler ces préférences avec l'api. La route /api/user/preference permet d'obtenir la valeur d'une option en GET et de l'écrire avec POST ou PATCH. Le code est prêt pour accepter n'importe quel code pour une préférence, et une valeur arbitraire en chaîne de caractères.
