...
## Petit glossaire
### Progression
Informations permettant d'évaluer la complétion des questions sur le nombre de questions

### Score
Note de A à E qui situe une collectivité par rapport à l'application du référentiel. Le score est calculé quand la progression est complète.