...
<div id="content" class="container-fluid">
    ...
    <div class="col-12 fil-ariane py-2 px-4">
        ...
        <i class="fas fa-chevron-right" style="color:#08433D"></i>
        <i class="fa-solid fa-clipboard-question" style="color: #08453F;"></i>
        <a class="fil-ariane" href="./gestQuestion.php">Gestion Questions</a>
    </div>

    <link rel="stylesheet" type="text/css" href="https://code.jquery.com/ui/1.9.2/themes/base/jquery-ui.css" />

    <div class="pt-5 d-flex col-12 justify-content-between">
        <span class="sous-titre">Gestion des questions</span>
    </div>
    ...
    <div id="buttons" class="col-md-12" style="float:right; margin-top: 20px;">
        ...
        <a href="#" data-toggle="modal" data-target=".bd-2-modal-lg">
            <button type="submit" id="modifier" class="btn btn-secondary cree btnline reduis">Modifier une question</button>
        </a>

        <a href="#" data-toggle="modal" data-target=".bd-1-modal-lg">
            <button type="submit" id="ajouter" class="btn btn-secondary cree btnline reduis">+ Ajouter une question</button>
        </a>
                    ...
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="form-group row col-md-12">
                                <h3 class="col-md-12 col-form-label" style="color:#4D4F5C">Question</h3>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="questionAjout" value="" required>
                                </div>
                            </div>
                    ...
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="form-group row col-md-12">
                                <h3 class="col-md-12 col-form-label" style="color:#4D4F5C">Question</h3>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="questionModif" value="" required>
                                </div>
                            </div>
