    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../AjaxLoader/UpdateQuestions.php">
...
<form action="../AjaxLoader/UpdateCategories.php" id="form-container">
    <div class="mt-5 px-3" id="formulaire"></div>
</form>

<div class="d-flex justify-content-end col-12">
    <button id="add" class="bouton-numeriscore px-5 py-3 rounded text-white">Question <i class="fas fa-plus-circle"></i></button>
</div>



<div class="mt-5 px-3">
    <h3 class="vertNumeriscore">Questions</h3>
