$(function() {
    ...
    var makeAsyncDataSource = function() {
        return new DevExpress.data.CustomStore({
            ...
            key: "Id",
            load: function() {
                return $.getJSON(`../AjaxLoader/GetUtilisateursOPSN.php`);
            }
        });
    }
        ...
        columns: [{
            ...
            cellTemplate: function(container, options) {
                ...
                if (options.value == 1) {
                    ...
                    $("<div>").append($(`<i class="fas fa-redo-alt vertNumeriscore" style='cursor:pointer;' title="Renvoyer le mail" onclick='renvoiMail("${options.data.Id}", "${options.data.Nom}", "${options.data.Prenom}", "${options.data.Identifiant}", "${options.data.Mail}")'></i>`)).appendTo(container);
                }
            },
            width: 80
        }, {
