...
<div id="content" class="container-fluid">
    ...
    <div class="profil-body" style="overflow: auto;">
        ...
        <div class="monProfil">
            <form action="./AjaxLoader/UpdateUtilisateurProfil.php?type=infos" id="formulaire">
        ...
        <div class="motDePasse">
            <form action="./AjaxLoader/UpdateUtilisateurProfil.php?type=mdp" id="formulaireMdp">
