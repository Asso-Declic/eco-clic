...
$(function () {
    ...
    $("#gridContainer").dxDataGrid({
        ...
        onExporting(e) {
            ...
            const worksheet = workbook.addWorksheet('Collectivites');
            ...
            DevExpress.excelExporter.exportDataGrid({
                ...
                saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'Collectivites.xlsx');
                });
            });
        },
        searchPanel: {
        ...
        },
        {
            ...
            cellTemplate: function (container, options) {
                ...
                <input type="checkbox" class="custom-control-input" id="customSwitch_${options.data.collectivite.id}" onchange='updateActive("${options.data.collectivite.id}")'>
...
function updateActive(collectiviteId) {
    $.ajax({
