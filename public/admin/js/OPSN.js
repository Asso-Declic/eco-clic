                            ...
                            onClick() {
                                $.ajax({
                                    ...
                                    error: function(resultat, statut, erreur) {
                                        console.error(resultat + ' --- ' + statut + ' --- ' + erreur);
                                        if (erreur == "Not Found") {
                                            DevExpress.ui.notify("Le siret est incorrect", "error");
                                        }
                                    }
                                });
                            },
                            elementAttr: {
                                class: 'bg-numeriscore',
                            },
                        },
                    }],
                    onValueChanged(data) {
...
function DisableForm(bool, Siret) {
    var champs = ["Nom", "Departement", "Telephone", "Mail", "Adresse", "Site_internet", "Departement_de_travail", "Description"];
